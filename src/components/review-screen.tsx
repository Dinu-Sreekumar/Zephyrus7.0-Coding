...
import { CheckCircle2, XCircle, Edit, Send, ShieldAlert, Timer } from 'lucide-react';
...
export function ReviewScreen({ submissions, onRevisit, onFinish, timeLeft }: ReviewScreenProps) {
                        ...
                        {problems.map((problem, index) => {
                            ...
                            return (
                                <div key={index} className="flex items-center justify-between p-4 rounded-lg border bg-muted/30">
                                    ...
                                    <Button variant="outline" size="sm" onClick={() => onRevisit(index)}>
